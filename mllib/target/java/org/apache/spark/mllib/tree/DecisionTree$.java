...
public  class DecisionTree$ implements scala.Serializable, org.apache.spark.Logging {
   ...
   */
  private  int predictNodeIndex (org.apache.spark.mllib.tree.model.Node node, int[] binnedFeatures, org.apache.spark.mllib.tree.model.Bin[][] bins, scala.collection.immutable.Set<java.lang.Object> unorderedFeatures) { throw new RuntimeException(); }
  /**
   ...
   */
  private  void mixedBinSeqOp (org.apache.spark.mllib.tree.impl.DTStatsAggregator agg, org.apache.spark.mllib.tree.impl.TreePoint treePoint, org.apache.spark.mllib.tree.model.Split[][] splits, scala.collection.immutable.Set<java.lang.Object> unorderedFeatures, double instanceWeight, scala.Option<int[]> featuresForNode) { throw new RuntimeException(); }
  /**
   ...
   * @param featuresForNode (undocumented)
   */
  private  void orderedBinSeqOp (org.apache.spark.mllib.tree.impl.DTStatsAggregator agg, org.apache.spark.mllib.tree.impl.TreePoint treePoint, double instanceWeight, scala.Option<int[]> featuresForNode) { throw new RuntimeException(); }
  /**
   ...
   * @param impurity (undocumented)
   */
  private  org.apache.spark.mllib.tree.model.InformationGainStats calculateGainForSplit (org.apache.spark.mllib.tree.impurity.ImpurityCalculator leftImpurityCalculator, org.apache.spark.mllib.tree.impurity.ImpurityCalculator rightImpurityCalculator, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, double impurity) { throw new RuntimeException(); }
  private  org.apache.spark.mllib.tree.model.Predict calculatePredict (org.apache.spark.mllib.tree.impurity.ImpurityCalculator impurityCalculator) { throw new RuntimeException(); }
  /**
   ...
   */
  private  scala.Tuple2<org.apache.spark.mllib.tree.model.Predict, java.lang.Object> calculatePredictImpurity (org.apache.spark.mllib.tree.impurity.ImpurityCalculator leftImpurityCalculator, org.apache.spark.mllib.tree.impurity.ImpurityCalculator rightImpurityCalculator) { throw new RuntimeException(); }
  /**
   ...
   */
  private  scala.Tuple3<org.apache.spark.mllib.tree.model.Split, org.apache.spark.mllib.tree.model.InformationGainStats, org.apache.spark.mllib.tree.model.Predict> binsToBestSplit (org.apache.spark.mllib.tree.impl.DTStatsAggregator binAggregates, org.apache.spark.mllib.tree.model.Split[][] splits, scala.Option<int[]> featuresForNode, org.apache.spark.mllib.tree.model.Node node) { throw new RuntimeException(); }
  /**
  ...
  private  scala.Tuple2<org.apache.spark.mllib.tree.model.Split[][], org.apache.spark.mllib.tree.model.Bin[][]> findSplitsBinsBySorting (org.apache.spark.rdd.RDD<org.apache.spark.mllib.regression.LabeledPoint> input, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, scala.collection.IndexedSeq<java.lang.Object> continuousFeatures) { throw new RuntimeException(); }
  /**
   ...
   */
    double[] findSplitsForContinuousFeature (double[] featureSamples, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, int featureIndex) { throw new RuntimeException(); }
}
