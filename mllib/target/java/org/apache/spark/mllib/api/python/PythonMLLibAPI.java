 ...
 */
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.feature.ChiSqSelectorModel fitChiSqSelector (int numTopFeatures, org.apache.spark.api.java.JavaRDD<org.apache.spark.mllib.regression.LabeledPoint> data) { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.mllib.api.python.PythonMLLibAPI.Word2VecModelWrapper trainWord2VecModel (org.apache.spark.api.java.JavaRDD<java.util.ArrayList<java.lang.String>> dataJRDD, int vectorSize, double learningRate, int numPartitions, int numIterations, long seed, int minCount) { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.evaluation.RankingMetrics<java.lang.Object> newRankingMetrics (org.apache.spark.sql.DataFrame predictionAndLabels) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.distributed.IndexedRowMatrix createIndexedRowMatrix (org.apache.spark.sql.DataFrame rows, long numRows, int numCols) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.distributed.CoordinateMatrix createCoordinateMatrix (org.apache.spark.sql.DataFrame rows, long numRows, long numCols) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.mllib.linalg.distributed.BlockMatrix createBlockMatrix (org.apache.spark.sql.DataFrame blocks, int rowsPerBlock, int colsPerBlock, long numRows, long numCols) { throw new RuntimeException(); }
  /**
   * Return the rows of an IndexedRowMatrix.
   * @param indexedRowMatrix (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.DataFrame getIndexedRows (org.apache.spark.mllib.linalg.distributed.IndexedRowMatrix indexedRowMatrix) { throw new RuntimeException(); }
  /**
   * Return the entries of a CoordinateMatrix.
   * @param coordinateMatrix (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.DataFrame getMatrixEntries (org.apache.spark.mllib.linalg.distributed.CoordinateMatrix coordinateMatrix) { throw new RuntimeException(); }
  /**
   * Return the sub-matrix blocks of a BlockMatrix.
   * @param blockMatrix (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.sql.DataFrame getMatrixBlocks (org.apache.spark.mllib.linalg.distributed.BlockMatrix blockMatrix) { throw new RuntimeException(); }
}
