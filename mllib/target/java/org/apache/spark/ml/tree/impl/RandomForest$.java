...
// no position
   ...
   */
  public  org.apache.spark.ml.tree.DecisionTreeModel[] run (org.apache.spark.rdd.RDD<org.apache.spark.mllib.regression.LabeledPoint> input, org.apache.spark.mllib.tree.configuration.Strategy strategy, int numTrees, java.lang.String featureSubsetStrategy, long seed, scala.Option<java.lang.String> parentUID) { throw new RuntimeException(); }
  /**
   ...
   * @param featuresForNode (undocumented)
   */
  private  void orderedBinSeqOp (org.apache.spark.mllib.tree.impl.DTStatsAggregator agg, org.apache.spark.ml.tree.impl.TreePoint treePoint, double instanceWeight, scala.Option<int[]> featuresForNode) { throw new RuntimeException(); }
  /**
   ...
   */
  protected  org.apache.spark.ml.tree.Split[][] findSplits (org.apache.spark.rdd.RDD<org.apache.spark.mllib.regression.LabeledPoint> input, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, long seed) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  long aggregateSizeForNode (org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, scala.Option<int[]> featureSubset) { throw new RuntimeException(); }
  /**
   ...
   */
    org.apache.spark.mllib.linalg.Vector featureImportances (org.apache.spark.ml.tree.DecisionTreeModel[] trees, int numFeatures) { throw new RuntimeException(); }
  /**
   ...
   */
    void computeFeatureImportance (org.apache.spark.ml.tree.Node node, org.apache.spark.util.collection.OpenHashMap<java.lang.Object, java.lang.Object> importances) { throw new RuntimeException(); }
  /**
   ...
   */
    void normalizeMapValues (org.apache.spark.util.collection.OpenHashMap<java.lang.Object, java.lang.Object> map) { throw new RuntimeException(); }
}
