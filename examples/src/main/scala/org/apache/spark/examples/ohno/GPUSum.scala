...
object GPUSum {
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("GPU Sum")
...
//    val n = 1280000000 * slices//10G
//    val N = 1280000000L * slices
//      println("N : " + N);

//    println("DataSize = " + (n*4) + "Byte")
    //make rdd of array
    val rdd1 = sc.parallelize(Array.fill(n)(floor(random * 3).toInt))
