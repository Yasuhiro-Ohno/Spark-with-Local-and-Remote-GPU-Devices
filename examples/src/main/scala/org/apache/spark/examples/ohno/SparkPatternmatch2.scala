...
//    println("n = " + n)
    ...
    //patternmatch(1)
    val rdd2 = rdd1.filter(line => line.contains("e gui")).count()
    ...
    //patternmatch(2)
    val rdd3 = rdd1.filter(line => line.contains("e gui")).count()
    ...
    //patternmatch(3)
    val rdd4 = rdd1.filter(line => line.contains("e gui")).count()
    ...
    //patternmatch(4)
    val rdd5 = rdd1.filter(line => line.contains("e gui")).count()
    ...
    //patternmatch(5)
    val rdd6 = rdd1.filter(line => line.contains("e gui")).count()
