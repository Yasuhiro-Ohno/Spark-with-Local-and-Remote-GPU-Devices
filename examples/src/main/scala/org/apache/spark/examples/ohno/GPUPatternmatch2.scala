...
// matching rate = 1%
object GPUPatternmatch2 {
  def main(args: Array[String]) {
    val start = System.nanoTime
    val conf = new SparkConf().setAppName("GPU Patternmatch2")
...
//    val n = 134217728 * slices//1G
    ...
    //patternmatch(1)
    val rdd3 = rdd2.patternmatchByGPU("e gui".getBytes())
    val start7 = System.nanoTime
    //patternmatch(2)
    val rdd4 = rdd2.patternmatchByGPU("e gui".getBytes())
    val start8 = System.nanoTime
    //patternmatch(3)
    val rdd5 = rdd2.patternmatchByGPU("e gui".getBytes())
    val start9 = System.nanoTime
    //patternmatch(4)
    val rdd6 = rdd2.patternmatchByGPU("e gui".getBytes())
    val start10 = System.nanoTime
    //patternmatch(5)
    val rdd7 = rdd2.patternmatchByGPU("e gui".getBytes())
    ...
    println("It takes(patternmatch1) " + (start7 - start6) / 1e9 + " s")
    println("It takes(patternmatch2) " + (start8 - start7) / 1e9 + " s")
    println("It takes(patternmatch3) " + (start9 - start8) / 1e9 + " s")
    println("It takes(patternmatch4) " + (start10 - start9) / 1e9 + " s")
    println("It takes(patternmatch5) " + (start11 - start10) / 1e9 + " s")
    sc.stop()
  }
}
