...
//    println("n = " + n)
    ...
    //patternmatch(1)
    //val rdd2 = rdd1.filter(line => line.contains("MLlib"))//10%
    val rdd2 = rdd1.filter(line => line.contains("###MR"))//20%
      //rdd2.reduce(_+_)
      //rdd2.max()
      //rdd2.collect()
    ...
    //patternmatch(2)
    //val rdd3 = rdd1.filter(line => line.contains("MLlib"))//10%
    val rdd3 = rdd1.filter(line => line.contains("###MR"))//20%
      //rdd3.reduce(_+_)
      //rdd3.max()
      //rdd3.collect()
    ...
    //patternmatch(3)
    //val rdd4 = rdd1.filter(line => line.contains("MLlib"))//10%
    val rdd4 = rdd1.filter(line => line.contains("###MR"))//20%
      //rdd4.reduce(_+_)
      //rdd4.max()
      //rdd4.collect()
    ...
    //patternmatch(4)
    //val rdd5 = rdd1.filter(line => line.contains("MLlib"))
    val rdd5 = rdd1.filter(line => line.contains("###MR"))//20%
      //rdd5.reduce(_+_)
      //rdd5.max()
      //rdd5.collect()
    ...
    //patternmatch(5)
    //val rdd6 = rdd1.filter(line => line.contains("MLlib"))
    val rdd6 = rdd1.filter(line => line.contains("###MR"))//20%
      //rdd6.reduce(_+_)
      //rdd6.max()
      //rdd6.collect()
    ...
    //rdd5.collect()
    //rdd6.collect()
    //val partition1 = rdd1.partitions.size
    //println("partition1 : " + partition1)
    //val partition2 = rdd2.partitions.size
