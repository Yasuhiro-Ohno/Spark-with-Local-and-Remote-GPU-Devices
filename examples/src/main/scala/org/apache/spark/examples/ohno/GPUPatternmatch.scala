...
// matching rate = 10%
object GPUPatternmatch {
  def main(args: Array[String]) {
    val start = System.nanoTime
    val conf = new SparkConf().setAppName("GPU Patternmatch")
...
//    val n = 134217728 * slices//1G
    ...
    //patternmatch(1)
    val rdd3 = rdd2.patternmatchByGPU("MLlib".getBytes())
    val start7 = System.nanoTime
    //patternmatch(2)
    val rdd4 = rdd2.patternmatchByGPU("MLlib".getBytes())
    val start8 = System.nanoTime
    //patternmatch(3)
    val rdd5 = rdd2.patternmatchByGPU("MLlib".getBytes())
    val start9 = System.nanoTime
    //patternmatch(4)
    val rdd6 = rdd2.patternmatchByGPU("MLlib".getBytes())
    val start10 = System.nanoTime
    //patternmatch(5)
    val rdd7 = rdd2.patternmatchByGPU("MLlib".getBytes())
