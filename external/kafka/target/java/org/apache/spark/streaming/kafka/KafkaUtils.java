...
public  class KafkaUtils {
  ...
  static private  scala.collection.immutable.Map<kafka.common.TopicAndPartition, scala.Tuple2<java.lang.String, java.lang.Object>> leadersForRanges (org.apache.spark.streaming.kafka.KafkaCluster kc, org.apache.spark.streaming.kafka.OffsetRange[] offsetRanges) { throw new RuntimeException(); }
  /** Make sure offsets are available in kafka, or throw an exception */
  static private  void checkOffsets (org.apache.spark.streaming.kafka.KafkaCluster kc, org.apache.spark.streaming.kafka.OffsetRange[] offsetRanges) { throw new RuntimeException(); }
