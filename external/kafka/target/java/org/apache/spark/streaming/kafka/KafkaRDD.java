 ...
 */
  class KafkaRDD<K extends java.lang.Object, V extends java.lang.Object, U extends kafka.serializer.Decoder<?>, T extends kafka.serializer.Decoder<?>, R extends java.lang.Object> extends org.apache.spark.rdd.RDD<R> implements org.apache.spark.Logging, org.apache.spark.streaming.kafka.HasOffsetRanges {
