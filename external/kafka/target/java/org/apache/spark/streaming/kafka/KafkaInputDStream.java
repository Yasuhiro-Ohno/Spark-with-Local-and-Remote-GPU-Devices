 ...
 */
  class KafkaInputDStream<K extends java.lang.Object, V extends java.lang.Object, U extends kafka.serializer.Decoder<?>, T extends kafka.serializer.Decoder<?>> extends org.apache.spark.streaming.dstream.ReceiverInputDStream<scala.Tuple2<K, V>> implements org.apache.spark.Logging {
  // not preceding
