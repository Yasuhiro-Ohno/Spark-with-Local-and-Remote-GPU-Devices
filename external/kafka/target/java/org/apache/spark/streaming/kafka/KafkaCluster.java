 ...
 */
  class KafkaCluster implements scala.Serializable {
  static   class LeaderOffset implements scala.Product, scala.Serializable {
  ...
  // no position
  static   class LeaderOffset$ extends scala.runtime.AbstractFunction3<java.lang.String, java.lang.Object, java.lang.Object, org.apache.spark.streaming.kafka.KafkaCluster.LeaderOffset> implements scala.Serializable {
    /**
   ...
   */
  static   class SimpleConsumerConfig extends kafka.consumer.ConsumerConfig {
  ...
  // no position
  static   class SimpleConsumerConfig$ {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
