 ...
 */
  class DirectKafkaInputDStream<K extends java.lang.Object, V extends java.lang.Object, U extends kafka.serializer.Decoder<K>, T extends kafka.serializer.Decoder<V>, R extends java.lang.Object> extends org.apache.spark.streaming.dstream.InputDStream<R> implements org.apache.spark.Logging {
  ...
  private  int maxRateLimitPerPartition () { throw new RuntimeException(); }
