 ...
 */
  class BatchedWriteAheadLog extends org.apache.spark.streaming.util.WriteAheadLog implements org.apache.spark.Logging {
  /**
  ...
  static private  byte[] getByteArray (java.nio.ByteBuffer buffer) { throw new RuntimeException(); }
