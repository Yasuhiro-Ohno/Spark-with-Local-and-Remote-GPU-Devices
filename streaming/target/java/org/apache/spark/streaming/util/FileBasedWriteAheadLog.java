 ...
 */
  class FileBasedWriteAheadLog extends org.apache.spark.streaming.util.WriteAheadLog implements org.apache.spark.Logging {
   ...
   * at any given time, where <code>n</code> is the size of the thread pool. This is crucial for use cases
   * where we create <code>FileBasedWriteAheadLogReader</code>s during parallel recovery. We don't want to
   * open up <code>k</code> streams altogether where <code>k</code> is the size of the Seq that we want to parallelize.
   * @param tpool (undocumented)
   * @param source (undocumented)
   * @param handler (undocumented)
   * @return (undocumented)
   */
  static public <I extends java.lang.Object, O extends java.lang.Object> scala.collection.Iterator<O> seqToParIterator (java.util.concurrent.ThreadPoolExecutor tpool, scala.collection.Seq<I> source, scala.Function1<I, scala.collection.Iterator<O>> handler) { throw new RuntimeException(); }
