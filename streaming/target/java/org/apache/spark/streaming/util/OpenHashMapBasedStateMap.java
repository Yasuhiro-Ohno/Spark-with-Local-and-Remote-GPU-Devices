...
/** Implementation of StateMap based on Spark's {@link org.apache.spark.util.collection.OpenHashMap} */
  class OpenHashMapBasedStateMap<K extends java.lang.Object, S extends java.lang.Object> extends org.apache.spark.streaming.util.StateMap<K, S> {
   ...
   * serialized bytes.
   */
  static public  class LimitMarker implements scala.Serializable {
  ...
  // not preceding
  public   OpenHashMapBasedStateMap (org.apache.spark.streaming.util.StateMap<K, S> parentStateMap, int initialCapacity, int deltaChainThreshold, scala.reflect.ClassTag<K> evidence$9, scala.reflect.ClassTag<S> evidence$10) { throw new RuntimeException(); }
  public   OpenHashMapBasedStateMap (int initialCapacity, int deltaChainThreshold, scala.reflect.ClassTag<K> evidence$11, scala.reflect.ClassTag<S> evidence$12) { throw new RuntimeException(); }
  public   OpenHashMapBasedStateMap (int deltaChainThreshold, scala.reflect.ClassTag<K> evidence$13, scala.reflect.ClassTag<S> evidence$14) { throw new RuntimeException(); }
  public   OpenHashMapBasedStateMap (scala.reflect.ClassTag<K> evidence$15, scala.reflect.ClassTag<S> evidence$16) { throw new RuntimeException(); }
