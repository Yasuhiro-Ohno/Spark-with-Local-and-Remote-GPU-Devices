...
/** Internal interface for defining the map that keeps track of sessions. */
 abstract class StateMap<K extends java.lang.Object, S extends java.lang.Object> implements scala.Serializable {
  static public <K extends java.lang.Object, S extends java.lang.Object> org.apache.spark.streaming.util.StateMap<K, S> empty (scala.reflect.ClassTag<K> evidence$3, scala.reflect.ClassTag<S> evidence$4) { throw new RuntimeException(); }
  static public <K extends java.lang.Object, S extends java.lang.Object> org.apache.spark.streaming.util.StateMap<K, S> create (org.apache.spark.SparkConf conf, scala.reflect.ClassTag<K> evidence$5, scala.reflect.ClassTag<S> evidence$6) { throw new RuntimeException(); }
  // not preceding
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Any))))
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Any))))
  public   StateMap (scala.reflect.ClassTag<K> evidence$1, scala.reflect.ClassTag<S> evidence$2) { throw new RuntimeException(); }
