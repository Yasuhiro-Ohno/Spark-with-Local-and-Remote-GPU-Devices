 ...
 * </code></pre>
 */
  class ActorReceiver<T extends java.lang.Object> extends org.apache.spark.streaming.receiver.Receiver<T> implements org.apache.spark.Logging {
  // not preceding
  ...
  protected  akka.actor.ActorRef actorSupervisor () { throw new RuntimeException(); }
  public  class Supervisor implements akka.actor.Actor {
    ...
    private  akka.actor.ActorRef worker () { throw new RuntimeException(); }
    private  java.util.concurrent.atomic.AtomicInteger n () { throw new RuntimeException(); }
    private  java.util.concurrent.atomic.AtomicInteger hiccups () { throw new RuntimeException(); }
