 ...
 */
   ...
   */
  private abstract class CatalystDecimalConverter extends org.apache.spark.sql.execution.datasources.parquet.CatalystPrimitiveConverter {
    public   CatalystDecimalConverter (int precision, int scale, org.apache.spark.sql.execution.datasources.parquet.ParentContainerUpdater updater) { throw new RuntimeException(); }
  ...
  private  class CatalystIntDictionaryAwareDecimalConverter extends org.apache.spark.sql.execution.datasources.parquet.CatalystRowConverter.CatalystDecimalConverter {
    public   CatalystIntDictionaryAwareDecimalConverter (int precision, int scale, org.apache.spark.sql.execution.datasources.parquet.ParentContainerUpdater updater) { throw new RuntimeException(); }
    public  void setDictionary (org.apache.parquet.column.Dictionary dictionary) { throw new RuntimeException(); }
  }
  private  class CatalystLongDictionaryAwareDecimalConverter extends org.apache.spark.sql.execution.datasources.parquet.CatalystRowConverter.CatalystDecimalConverter {
    public   CatalystLongDictionaryAwareDecimalConverter (int precision, int scale, org.apache.spark.sql.execution.datasources.parquet.ParentContainerUpdater updater) { throw new RuntimeException(); }
    public  void setDictionary (org.apache.parquet.column.Dictionary dictionary) { throw new RuntimeException(); }
  }
  private  class CatalystBinaryDictionaryAwareDecimalConverter extends org.apache.spark.sql.execution.datasources.parquet.CatalystRowConverter.CatalystDecimalConverter {
    public   CatalystBinaryDictionaryAwareDecimalConverter (int precision, int scale, org.apache.spark.sql.execution.datasources.parquet.ParentContainerUpdater updater) { throw new RuntimeException(); }
    public  void setDictionary (org.apache.parquet.column.Dictionary dictionary) { throw new RuntimeException(); }
  }
  /**
  ...
  private  org.apache.spark.sql.catalyst.expressions.SpecificMutableRow currentRow () { throw new RuntimeException(); }
