 ...
 */
public  class DDLParser extends org.apache.spark.sql.catalyst.AbstractSparkSQLParser implements org.apache.spark.sql.catalyst.util.DataTypeParser, org.apache.spark.Logging {
  ...
  /**
   * <code>CREATE [TEMPORARY] TABLE [IF NOT EXISTS] avroTable
   * USING org.apache.spark.sql.avro
   * OPTIONS (path "../hive/src/test/resources/data/files/episodes.avro")</code>
   * or
   * <code>CREATE [TEMPORARY] TABLE [IF NOT EXISTS] avroTable(intField int, stringField string...)
   * USING org.apache.spark.sql.avro
   * OPTIONS (path "../hive/src/test/resources/data/files/episodes.avro")</code>
   * or
   * <code>CREATE [TEMPORARY] TABLE [IF NOT EXISTS] avroTable
