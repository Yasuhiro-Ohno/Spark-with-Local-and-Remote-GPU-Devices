...
public  class JdbcUtils$ implements org.apache.spark.Logging {
   ...
   * @return (undocumented)
   */
  public  java.sql.Connection createConnection (java.lang.String url, java.util.Properties connectionProperties) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.sql.PreparedStatement insertStatement (java.sql.Connection conn, java.lang.String table, org.apache.spark.sql.types.StructType rddSchema) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  java.lang.String schemaString (org.apache.spark.sql.DataFrame df, java.lang.String url) { throw new RuntimeException(); }
  /**
   ...
   */
  public  void saveTable (org.apache.spark.sql.DataFrame df, java.lang.String url, java.lang.String table, java.util.Properties properties) { throw new RuntimeException(); }
}
