 ...
 */
  ...
  private  org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> mergeWithPartitionValues (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> requiredColumns, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> dataColumns, org.apache.spark.sql.types.StructType partitionColumnSchema, org.apache.spark.sql.catalyst.InternalRow partitionValues, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow> dataRows) { throw new RuntimeException(); }
  ...
  protected  org.apache.spark.sql.execution.SparkPlan pruneFilterProjectRaw (org.apache.spark.sql.execution.datasources.LogicalRelation relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.NamedExpression> projects, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> filterPredicates, scala.Function3<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute>, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, scala.collection.Seq<org.apache.spark.sql.sources.Filter>, org.apache.spark.rdd.RDD<org.apache.spark.sql.catalyst.InternalRow>> scanBuilder) { throw new RuntimeException(); }
  /**
