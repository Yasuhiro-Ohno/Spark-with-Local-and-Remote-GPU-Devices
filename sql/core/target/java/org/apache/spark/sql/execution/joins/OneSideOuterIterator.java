...
public abstract class OneSideOuterIterator extends org.apache.spark.sql.execution.RowIterator {
  public   OneSideOuterIterator (org.apache.spark.sql.execution.joins.SortMergeJoinScanner smjScanner, org.apache.spark.sql.catalyst.InternalRow bufferedSideNullRow, scala.Function1<org.apache.spark.sql.catalyst.InternalRow, java.lang.Object> boundCondition, scala.Function1<org.apache.spark.sql.catalyst.InternalRow, org.apache.spark.sql.catalyst.InternalRow> resultProj, org.apache.spark.sql.execution.metric.LongSQLMetric numOutputRows) { throw new RuntimeException(); }
