...
public  class LimitNode extends org.apache.spark.sql.execution.local.UnaryLocalNode implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   LimitNode (org.apache.spark.sql.SQLConf conf, int limit, org.apache.spark.sql.execution.local.LocalNode child) { throw new RuntimeException(); }
