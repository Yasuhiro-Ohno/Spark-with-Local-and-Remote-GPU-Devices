...
public  class ConvertToSafeNode extends org.apache.spark.sql.execution.local.UnaryLocalNode implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ConvertToSafeNode (org.apache.spark.sql.SQLConf conf, org.apache.spark.sql.execution.local.LocalNode child) { throw new RuntimeException(); }
