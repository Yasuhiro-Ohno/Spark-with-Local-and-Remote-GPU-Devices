...
public  class JacksonParser$ {
   ...
   * @return (undocumented)
   */
  public  Object convertField (com.fasterxml.jackson.core.JsonFactory factory, com.fasterxml.jackson.core.JsonParser parser, org.apache.spark.sql.types.DataType schema) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.util.MapData convertMap (com.fasterxml.jackson.core.JsonFactory factory, com.fasterxml.jackson.core.JsonParser parser, org.apache.spark.sql.types.DataType valueType) { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.util.ArrayData convertArray (com.fasterxml.jackson.core.JsonFactory factory, com.fasterxml.jackson.core.JsonParser parser, org.apache.spark.sql.types.DataType elementType) { throw new RuntimeException(); }
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> parseJson (scala.collection.Iterator<java.lang.String> input, org.apache.spark.sql.types.StructType schema, java.lang.String columnNameOfCorruptRecords, org.apache.spark.sql.execution.datasources.json.JSONOptions configOptions) { throw new RuntimeException(); }
}
