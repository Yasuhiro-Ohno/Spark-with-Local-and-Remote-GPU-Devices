...
public  interface HashOuterJoin {
  ...
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.InternalRow> fullOuterIterator (org.apache.spark.sql.catalyst.InternalRow key, scala.collection.Iterable<org.apache.spark.sql.catalyst.InternalRow> leftIter, scala.collection.Iterable<org.apache.spark.sql.catalyst.InternalRow> rightIter, org.apache.spark.sql.catalyst.expressions.JoinedRow joinedRow, scala.Function1<org.apache.spark.sql.catalyst.InternalRow, org.apache.spark.sql.catalyst.InternalRow> resultProjection, org.apache.spark.sql.execution.metric.LongSQLMetric numOutputRows) ;
