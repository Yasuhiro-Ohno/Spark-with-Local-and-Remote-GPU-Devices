...
public abstract class UnaryExpression extends org.apache.spark.sql.catalyst.expressions.Expression {
   ...
   * null, and if not not null, use <code>f</code> to generate the expression.
   * <p>
   ...
   * @return (undocumented)
   */
  protected  java.lang.String defineCodeGen (org.apache.spark.sql.catalyst.expressions.codegen.CodeGenContext ctx, org.apache.spark.sql.catalyst.expressions.codegen.GeneratedExpressionCode ev, scala.Function1<java.lang.String, java.lang.String> f) { throw new RuntimeException(); }
  /**
   * Called by unary expressions to generate a code block that returns null if its parent returns
   * null, and if not not null, use <code>f</code> to generate the expression.
   * <p>
   ...
   * @return (undocumented)
   */
  protected  java.lang.String nullSafeCodeGen (org.apache.spark.sql.catalyst.expressions.codegen.CodeGenContext ctx, org.apache.spark.sql.catalyst.expressions.codegen.GeneratedExpressionCode ev, scala.Function1<java.lang.String, java.lang.String> f) { throw new RuntimeException(); }
}
