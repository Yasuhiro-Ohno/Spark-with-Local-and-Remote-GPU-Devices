...
// no position
/**
 * Generates bytecode that produces a new {@link InternalRow} object based on a fixed set of input
 * {@link Expression Expressions} and a given input {@link InternalRow}.  The returned {@link InternalRow}
 * object is custom generated based on the output types of the {@link Expression} to avoid boxing of
 * primitive values.
 */
