...
public  class NumberConverter$ {
  ...
  private  byte[] value () { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  private  long unsignedLongDiv (long x, int m) { throw new RuntimeException(); }
  /**
   * Decode v into value[].
   * <p>
   ...
   */
  private  void decode (long v, int radix) { throw new RuntimeException(); }
  /**
   ...
   */
  private  long encode (int radix, int fromPos) { throw new RuntimeException(); }
  /**
   ...
   */
  private  void byte2char (int radix, int fromPos) { throw new RuntimeException(); }
  /**
   ...
   * @param fromPos is the first nonzero element
   */
  private  void char2byte (int radix, int fromPos) { throw new RuntimeException(); }
  /**
