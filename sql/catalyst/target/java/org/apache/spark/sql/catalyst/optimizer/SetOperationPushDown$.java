...
public  class SetOperationPushDown$ extends org.apache.spark.sql.catalyst.rules.Rule<org.apache.spark.sql.catalyst.plans.logical.LogicalPlan> implements org.apache.spark.sql.catalyst.expressions.PredicateHelper {
  ...
  public   SetOperationPushDown$ () { throw new RuntimeException(); }
  /**
   * Maps Attributes from the left side to the corresponding Attribute on the right side.
   * @param bn (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.expressions.AttributeMap<org.apache.spark.sql.catalyst.expressions.Attribute> buildRewrites (org.apache.spark.sql.catalyst.plans.logical.BinaryNode bn) { throw new RuntimeException(); }
  /**
