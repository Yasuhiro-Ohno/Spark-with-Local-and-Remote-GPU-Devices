...
public  class GenerateUnsafeProjection extends org.apache.spark.sql.catalyst.expressions.codegen.CodeGenerator<scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression>, org.apache.spark.sql.catalyst.expressions.UnsafeProjection> {
  ...
  static private  java.lang.String rowWriterClass () { throw new RuntimeException(); }
  static private  java.lang.String arrayWriterClass () { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.catalyst.expressions.codegen.GeneratedExpressionCode createCode (org.apache.spark.sql.catalyst.expressions.codegen.CodeGenContext ctx, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> expressions, boolean useSubexprElimination) { throw new RuntimeException(); }
  ...
  static protected  org.apache.spark.sql.catalyst.expressions.UnsafeProjection create (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> expressions) { throw new RuntimeException(); }
