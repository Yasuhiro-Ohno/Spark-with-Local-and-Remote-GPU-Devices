...
public  class NumberConverter {
  static private  byte[] value () { throw new RuntimeException(); }
  /**
   ...
   */
  static private  void decode (long v, int radix) { throw new RuntimeException(); }
  /**
   ...
   */
  static private  long encode (int radix, int fromPos) { throw new RuntimeException(); }
  /**
   ...
   */
  static private  void byte2char (int radix, int fromPos) { throw new RuntimeException(); }
  /**
   ...
   * @param fromPos is the first nonzero element
   */
  static private  void char2byte (int radix, int fromPos) { throw new RuntimeException(); }
  /**
