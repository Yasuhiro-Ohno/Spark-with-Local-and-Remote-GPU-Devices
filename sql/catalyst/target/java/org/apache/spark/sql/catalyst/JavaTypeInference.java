...
public  class JavaTypeInference {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.catalyst.expressions.Expression constructorFor (java.lang.Class<?> beanClass) { throw new RuntimeException(); }
  static private  org.apache.spark.sql.catalyst.expressions.Expression constructorFor (com.google.common.reflect.TypeToken<?> typeToken, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> path) { throw new RuntimeException(); }
  /**
   * Returns expressions for extracting all the fields from the given type.
   * @param beanClass (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.catalyst.expressions.CreateNamedStruct extractorsFor (java.lang.Class<?> beanClass) { throw new RuntimeException(); }
  static private  org.apache.spark.sql.catalyst.expressions.Expression extractorFor (org.apache.spark.sql.catalyst.expressions.Expression inputObject, com.google.common.reflect.TypeToken<?> typeToken) { throw new RuntimeException(); }
}
