...
public  class VariancePop extends org.apache.spark.sql.catalyst.expressions.aggregate.CentralMomentAgg implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   VariancePop (org.apache.spark.sql.catalyst.expressions.Expression child, int mutableAggBufferOffset, int inputAggBufferOffset) { throw new RuntimeException(); }
