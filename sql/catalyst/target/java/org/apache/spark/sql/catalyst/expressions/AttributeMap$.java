...
public  class AttributeMap$ implements scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.expressions.AttributeMap<java.lang.Object> byIndex (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> schema) { throw new RuntimeException(); }
  /** Given a schema, constructs a map from ordinal to Attribute. */
  public  scala.collection.immutable.Map<java.lang.Object, org.apache.spark.sql.catalyst.expressions.Attribute> toIndex (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> schema) { throw new RuntimeException(); }
}
