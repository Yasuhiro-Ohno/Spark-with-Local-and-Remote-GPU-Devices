...
public  interface PathInstruction {
  // no position
  static   class Subscript$ implements org.apache.spark.sql.catalyst.expressions.PathInstruction, scala.Product, scala.Serializable {
    /**
  ...
  // no position
  static   class Wildcard$ implements org.apache.spark.sql.catalyst.expressions.PathInstruction, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
  ...
  // no position
  static   class Key$ implements org.apache.spark.sql.catalyst.expressions.PathInstruction, scala.Product, scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
  ...
  // no position
  static   class Index$ extends scala.runtime.AbstractFunction1<java.lang.Object, org.apache.spark.sql.catalyst.expressions.PathInstruction.Index> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
  ...
  // no position
  static   class Named$ extends scala.runtime.AbstractFunction1<java.lang.String, org.apache.spark.sql.catalyst.expressions.PathInstruction.Named> implements scala.Serializable {
    /**
     * Static reference to the singleton instance of this Scala object.
     */
