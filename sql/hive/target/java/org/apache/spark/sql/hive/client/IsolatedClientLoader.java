package org.apache.spark.sql.hive.client;
  class IsolatedClientLoader implements org.apache.spark.Logging {
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.util.MutableURLClassLoader classLoader () { throw new RuntimeException(); }
    void addJar (java.net.URL path) { throw new RuntimeException(); }
  /** The isolated client interface to Hive. */
    org.apache.spark.sql.hive.client.ClientInterface createClient () { throw new RuntimeException(); }
  /**
   * The place holder for shared Hive client for all the HiveContext sessions (they share an
   * IsolatedClientLoader).
   * @return (undocumented)
   */
  public  Object cachedHive () { throw new RuntimeException(); }
}
