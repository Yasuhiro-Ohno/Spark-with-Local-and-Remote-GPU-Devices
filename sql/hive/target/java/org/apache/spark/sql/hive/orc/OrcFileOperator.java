...
// no position
  class OrcFileOperator implements org.apache.spark.Logging {
  /**
   ...
   * @return (undocumented)
   */
  static public  scala.Option<org.apache.hadoop.hive.ql.io.orc.Reader> getFileReader (java.lang.String basePath, scala.Option<org.apache.hadoop.conf.Configuration> config) { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.StructType readSchema (java.lang.String path, scala.Option<org.apache.hadoop.conf.Configuration> conf) { throw new RuntimeException(); }
