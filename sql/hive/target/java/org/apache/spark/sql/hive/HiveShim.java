...
// no position
  ...
  static   class HiveFunctionWrapper implements java.io.Externalizable, scala.Product, scala.Serializable {
    ...
    public <T extends java.lang.Object> T deserializeObjectByKryo (com.esotericsoftware.kryo.Kryo kryo, java.io.InputStream in, java.lang.Class<?> clazz, scala.reflect.ClassTag<T> evidence$1) { throw new RuntimeException(); }
    public  void serializeObjectByKryo (com.esotericsoftware.kryo.Kryo kryo, java.lang.Object plan, java.io.OutputStream out) { throw new RuntimeException(); }
  ...
  // no position
  static   class HiveFunctionWrapper$ extends scala.runtime.AbstractFunction2<java.lang.String, java.lang.Object, org.apache.spark.sql.hive.HiveShim.HiveFunctionWrapper> implements scala.Serializable {
    /**
  ...
  static   class ShimFileSinkDesc implements scala.Serializable, org.apache.spark.Logging {
