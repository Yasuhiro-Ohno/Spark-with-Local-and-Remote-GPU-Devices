...
public  class SparkContext implements org.apache.spark.Logging, org.apache.spark.ExecutorAllocationClient {
  ...
  static public <T extends java.lang.Object> org.apache.spark.rdd.AsyncRDDActions<T> rddToAsyncRDDActions (org.apache.spark.rdd.RDD<T> rdd, scala.reflect.ClassTag<T> evidence$22) { throw new RuntimeException(); }
  static public <K extends java.lang.Object, V extends java.lang.Object> org.apache.spark.rdd.SequenceFileRDDFunctions<K, V> rddToSequenceFileRDDFunctions (org.apache.spark.rdd.RDD<scala.Tuple2<K, V>> rdd, scala.Function1<K, org.apache.hadoop.io.Writable> evidence$23, scala.reflect.ClassTag<K> evidence$24, scala.Function1<V, org.apache.hadoop.io.Writable> evidence$25, scala.reflect.ClassTag<V> evidence$26) { throw new RuntimeException(); }
  static public <K extends java.lang.Object, V extends java.lang.Object> org.apache.spark.rdd.OrderedRDDFunctions<K, V, scala.Tuple2<K, V>> rddToOrderedRDDFunctions (org.apache.spark.rdd.RDD<scala.Tuple2<K, V>> rdd, scala.math.Ordering<K> evidence$27, scala.reflect.ClassTag<K> evidence$28, scala.reflect.ClassTag<V> evidence$29) { throw new RuntimeException(); }
  ...
  static private <T extends java.lang.Object> org.apache.hadoop.io.ArrayWritable arrayToArrayWritable (scala.collection.Traversable<T> arr, scala.Function1<T, org.apache.hadoop.io.Writable> evidence$30, scala.reflect.ClassTag<T> evidence$31) { throw new RuntimeException(); }
  ...
  public  java.util.concurrent.atomic.AtomicBoolean stopped () { throw new RuntimeException(); }
  ...
  public  ohno.RDD_Collection[] rdd_collections () { throw new RuntimeException(); }
  public  int count () { throw new RuntimeException(); }
  public  ohno.Int_RDD_Collection[] int_rdd_collections () { throw new RuntimeException(); }
  public  int int_count () { throw new RuntimeException(); }
  public  ohno.Double_RDD_Collection[] double_rdd_collections () { throw new RuntimeException(); }
  public  int double_count () { throw new RuntimeException(); }
  public  ohno.IntInt_RDD_Collection[] intint_rdd_collections () { throw new RuntimeException(); }
  public  int intint_count () { throw new RuntimeException(); }
  public  ohno.IntString_RDD_Collection[] intstring_rdd_collections () { throw new RuntimeException(); }
  public  int intstring_count () { throw new RuntimeException(); }
  public  ohno.Byte_RDD_Collection[] byte_rdd_collections () { throw new RuntimeException(); }
  public  int byte_count () { throw new RuntimeException(); }
  /**
   * :: DeveloperApi ::
   * Alternative constructor for setting preferred locations where Spark will create executors.
   * <p>
   * @param config a {@link org.apache.spark.SparkConf} object specifying other Spark parameters
   ...
   * Create a new partition for each collection item. */
  public  void registerRDD (int id, int[] array) { throw new RuntimeException(); }
  public  void registerRDD (int id, double[] array) { throw new RuntimeException(); }
  public  void registerRDD (int id, byte[] array) { throw new RuntimeException(); }
  public  void registerRDD (int id, int[] ks_array, int[] array) { throw new RuntimeException(); }
  public  void registerRDD (int id, int[] ks_array, java.lang.String[] array) { throw new RuntimeException(); }
  public  void registeredRDD () { throw new RuntimeException(); }
  /**
   ...
   */
    boolean requestTotalExecutors (int numExecutors, int localityAwareTasks, scala.collection.immutable.Map<java.lang.String, java.lang.Object> hostToLocalTaskCount) { throw new RuntimeException(); }
  /**
   * :: DeveloperApi ::
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.collection.Seq<java.lang.Object> partitions, boolean allowLocal, scala.reflect.ClassTag<U> evidence$16) { throw new RuntimeException(); }
  /**
   * Run a job on a given set of partitions of an RDD, but take a function of type
   * <code>Iterator[T] =&gt; U</code> instead of <code>(TaskContext, Iterator[T]) =&gt; U</code>.
   * <p>
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function1<scala.collection.Iterator<T>, U> func, scala.collection.Seq<java.lang.Object> partitions, boolean allowLocal, scala.reflect.ClassTag<U> evidence$17) { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function2<org.apache.spark.TaskContext, scala.collection.Iterator<T>, U> func, scala.reflect.ClassTag<U> evidence$18) { throw new RuntimeException(); }
  /**
   * Run a job on all partitions in an RDD and return the results in an array.
   * @param rdd (undocumented)
   * @param func (undocumented)
   ...
   * @return (undocumented)
   */
  public <T extends java.lang.Object, U extends java.lang.Object> java.lang.Object runJob (org.apache.spark.rdd.RDD<T> rdd, scala.Function1<scala.collection.Iterator<T>, U> func, scala.reflect.ClassTag<U> evidence$19) { throw new RuntimeException(); }
  /**
